...
\titlehead{Jendrik Stelzner
\hfill \texttt{jendrikstelzner.de/seminars/dg-hopf.pdf}
\hfill May 20, 2019%
\footnote{Last change: \today}
}
...
A \defemph{\dgv} is the same as a chain complex of vector spaces, a \defemph{\dgsub} the same as a chain subcomplex.
